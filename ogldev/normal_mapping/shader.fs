...
{
    normal = normalize(cameraSpaceNormal);
...
{
    return LightContribute(light.base, light.direction, cameraSpaceNormal);
}
...
vec4 PointLightContribute(PointLight light)
{
    ...
    return LightContribute(light.base, direction, cameraSpaceNormal) / attenuation;
}
